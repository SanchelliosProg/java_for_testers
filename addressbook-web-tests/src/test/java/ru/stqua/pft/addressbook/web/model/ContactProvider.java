        ...
        switch (address) {
            case FRODO_BAGGINS:
                return ContactData.newBuilder().firstName(ContactsLabels.FRODO_BAGGINS.getName())
                        ...
                        .email("frodoBaggins@midlemail.me").group(GroupLabels.BROTHERHOOD_OF_RING).noPhoto().build();
            case JOHN_MATRIX:
                return ContactData.newBuilder().firstName(ContactsLabels.JOHN_MATRIX.getName())
                        ...
                        .email("john_matrix@besttimes.us").group(GroupLabels.COOL_ACTION_MOVIES).noPhoto().build();
            case CASEY_RAYBACK:
                return ContactData.newBuilder().firstName(ContactsLabels.CASEY_RAYBACK.getName())
                        ...
                        .email("rayback@powerofliberty.us").group(GroupLabels.COOL_ACTION_MOVIES).noPhoto().build();
            case M_GHANDI:
                return ContactData.newBuilder().firstName(ContactsLabels.M_GHANDI.getName())
                        .lastName("Ghandi").address("India")
                        .homePhoneOnly(generateRandomNumber())
                        .email("ghandi@peace.in").group(GroupLabels.GOOD_PEOPLE).noPhoto().build();
            case MARTIN_RIGGS:
                return ContactData.newBuilder().firstName(ContactsLabels.MARTIN_RIGGS.getName())
                        ...
                        .group(GroupLabels.COOL_ACTION_MOVIES).noPhoto().build();
            case GORBY:
